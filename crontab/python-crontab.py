...
# =====================
'''
Several users have reported their new crontabs not saving automatically.
At this point you MUST use write() if you want your edits to be saved out.
See below for full details on the use of the write function.
...
# Each job can return a log iterator too, these are filtered
# so you can see when the last execution was::
...
default date_from is the current date/time if not specified.
'''
# Datetime of the next job::
